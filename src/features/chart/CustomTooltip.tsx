...
function CustomTooltip({ active, payload }: CustomTooltipProps) {
  ...
  if (active && payload && payload.length > 0) {
    return (
      <div className="w-[150px] md:w-[175px] bg-neutral-0 p-100 md:p-150 flex flex-col items-start gap-100 md:gap-150 rounded-10 shadow-[0_4px_7px_rgba(33,33,77,0.16)]">
        <div>
          <h6 className="text-preset-8 text-neutral-600 mb-050 md:mb-075">
            Mood
          </h6>
        ...
        <div>
          <h6 className="text-preset-8 text-neutral-600 md:mb-075">Tags</h6>
